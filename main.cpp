 ...
 * File:   main.cpp
 * Author: Danny Obeid
 * Created on April 20th, 2019, 6:50 PM
 * Purpose:  Project 1 
*/
...
stack<Card> shuDeck();              // the deck is built and shuffled 
...
stack<Card> shuDeck()
{
    // Creates an unordered map to create the deck 
    ...
    // Goes in and sets the maximum value of the cards to 10 and initalizes the suits
    for (int i = 0; i < 4; i++)
    {
        for (int j = 1; j < 14; j++)
        {
    ...
    // Shuffles the deck and returns the done deck that is to be used to play
